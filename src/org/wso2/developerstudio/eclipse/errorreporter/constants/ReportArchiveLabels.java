...
public class ReportArchiveLabels {
	...
	public static final String TABLE_LABEL_3 = "Date & Time";
	public static final String TABLE_LABEL_4 = "Error Message";
	
	public static final String CONTEXT_MENU_TEXT = "Inquire status";
}
